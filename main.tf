...
resource "azurerm_mysql_flexible_server" "this_manual_grow" {
  count = var.storage == null || !var.storage.auto_grow_enabled ? 1 : 0
...
resource "azurerm_mysql_flexible_server" "this_auto_grow" {
  count = var.storage != null && var.storage.auto_grow_enabled ? 1 : 0
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  ...
  target_resource_id             = local.mysql_server.id
